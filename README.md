...
[![Tests](https://img.shields.io/badge/Tests-78+-success.svg)](tests/)
[![Coverage](https://img.shields.io/badge/Coverage-72%25-success.svg)](tests/)
...
Проект имеет высокое покрытие тестами (**72%**, выше требуемых 70%):

- ✅ **78+ тестов** покрывают все основные компоненты
...
- ✅ **Pytest**: 78+ тестов с покрытием 72%
...
- **beautifulsoup4** (>=4.14.3) - Парсинг HTML страниц
...
- **types-requests**, **types-beautifulsoup4** - Типы для mypy
