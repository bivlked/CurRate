...
@pytest.mark.parametrize(
    ...
    [
        ...
        (" 500 ", 500.0),
        ("1_000", 1000.0),
        ("1.234", 1234.0),  # одна точка с 3 цифрами = разделитель тысяч
        ("1.23", 1.23),  # одна точка с 2 цифрами = десятичный разделитель
        ("1.2345", 1.2345),  # одна точка с 4 цифрами = десятичный разделитель
        ("1.234.567", 1234567.0),  # несколько точек = разделители тысяч
        ("1,234,567", 1234567.0),  # несколько запятых = разделители тысяч
        ("123.456.789,45", 123456789.45),  # точки как тысячи, запятая как десятичный
        ("123,456,789.12", 123456789.12),  # запятые как тысячи, точка как десятичный
    ],
)
